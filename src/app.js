...
const labResultRoute = require("./routes/labResult.routes");
...
const maternityLifeCycleRoute = require("./routes/maternity.lifecycle.routes");
...
const reportingRoute = require("./routes/report.routes");
...
app.use("/api/maternityLifeCycle",maternityLifeCycleRoute);
app.use("/api/medicationStock", medicationStockRoutes);
